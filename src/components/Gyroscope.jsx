...
import { BLE_GYROSCOPE_UUID, CHART_INITIAL_DATA, IMU_NUM_SAMPLES } from '../utils/constants';
import MultilineChart from './MultilineChart';

const Gyroscope = ({ className, bleService, addSample }) => {
  ...
  return (
    <div className={className}>
      <p>Gyroscope last measurement</p>
